...
export default withNativeFederation({
  ...
  // Declared here for the same reason `apps/assistant`'s config declares
  // them: singleton across the federation boundary, not just within this
  // build, so `AssistantInvalidPayloadError` (from `console/data-access`)
  // is one class regardless of which side of the boundary constructs it.
